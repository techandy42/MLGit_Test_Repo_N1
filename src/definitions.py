...
def dynamic_type_method_1(self):
    print(f"DummyDynamicsClass1.dynamic_type_method_1()")
...
def dynamic_type_body_1(ns):
    ...
    ns['method_1']  = lambda self: print(f"DynamicTypeCreation1.method_1()")
...
class DummyMeta1(type):
    def __new__(mcls, name, bases, namespace):
        namespace['method_1'] = lambda self: print("DummyMeta1.method_1()")
...
class DummyProtocol1Impl(DummyProtocol1):
    def method_1(self):
        print("DummyProtocol1Impl.method_1()")
